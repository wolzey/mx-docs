    ...
    >
      ...
      <div class="relative">
        ...
        <input
          ...
          ref="search"
          v-model="q"
          class="block w-full pl-10 pr-3 py-2 truncate leading-5 placeholder-neutral-500 border border-transparent text-neutral-700 dark:text-white dark-focus:text-white focus:border-neutral-300 dark-focus:border-neutral-700 rounded-none focus:outline-none focus:bg-white dark-focus:bg-neutral-900 bg-neutral-200 dark:bg-neutral-800"
    ...
    >
      ...
      >
        <NuxtLink
          ...
          :class="{
            'text-primary-500 bg-neutral-200 dark:bg-neutral-800':
              focusIndex === index,
          }"
          @click="focus = false"
        >
          ...
          <svg-icon
            ...
            name="chevron/right"
            class="w-3 h-3 mx-1 text-neutral-900"
            height="12px"
            width="12px"
          />
          {{ result.title }}
